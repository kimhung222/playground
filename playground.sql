...
(2, '2017_07_04_173633_create_otps_table', 2),
(3, '2017_07_04_184051_add_telephone_to_users', 3);
...
ALTER TABLE `opts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `opts_user_id_foreign` (`user_id`);
...
--
ALTER TABLE `opts`
  ADD CONSTRAINT `opts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
